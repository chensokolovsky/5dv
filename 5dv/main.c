...
void printUsage() {
    ...
    printf("4) 5dv full [folder name]. Runs the full process: create, encode, decode, shhow. All files will get created in that folder. Make sure the folder exists and empty\n");
